...
function DesignPage() {
  ...
  return (
    ...
    <div>
        <div >
            <div className='flex flex-col gap-y-2 ml-1 mt-10 font-semibold'>
            <div className="overflow-x-auto sm:-mx-6 lg:-mx-8">
                ...
                <div className="overflow-hidden">
                    ...
                    <thead className="border-b font-medium dark:border-neutral-500">
                        ...
                        <th scope="col" className="px-6 py-2">Practice</th>
            ...
            <tbody>
            {
                    posts.map((post, index) => (
                            ...
                            <tr className="border-b dark:border-neutral-500">
                                ...
                                <td className="whitespace-wrap text-[16px] font-medium px-6 py-2">{post.title}</td>
