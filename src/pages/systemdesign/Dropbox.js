...
function Dropbox() {
  return (
    <div >
        <p className='p-2 text-[16px]'><strong className='font-semibold '><NavLink to="/"> Home </NavLink><NavLink to="/System-Design"> / System Design  </NavLink><NavLink to="/System-Design-Apps"> / System Design Apps </NavLink></strong>  / Dropbox</p>
