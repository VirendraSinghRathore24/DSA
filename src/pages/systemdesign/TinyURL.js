...
function TinyURL() {
  return (
    <div >
        <p className='p-2 text-[16px]'><strong className='font-semibold '><NavLink to="/"> Home </NavLink><NavLink to="/System-Design"> / System Design  </NavLink><NavLink to="/real-Life-Apps"> / System Design Apps </NavLink></strong>  / Tiny URL</p>
